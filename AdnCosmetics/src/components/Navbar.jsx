...
export default function Navbar() {
  ...
  // Cambia la opacidad del fondo al hacer scroll
  useEffect(() => {
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── Marca/Logo ── */
        .vdn-nav-brand { display: flex; align-items: center; gap: 14px; cursor: pointer; }
        .vdn-nav-brand-text {
        ...
        .vdn-hamburger span {
          ...
          background: var(--pink-soft); border-radius: 2px;
          transition: all 0.3s;
        }
      ...
      <nav className="vdn-nav">
        {/* Logo */}
        <div className="vdn-nav-brand" onClick={() => scrollTo("#inicio")}>
          <div>
