    ...
    <>
      ...
      >
        <div className="quienes">
          <div className="quienes-left reveal">
            ...
            <h2>Belleza sin<br />fronteras, <em>para Bolivia</em></h2>
      ...
      <section className="conquienes">
        ...
        <div className="conquienes-header reveal">
          ...
          <h2>¿Con quiénes<br /><span>trabajamos?</span></h2>
        ...
        <div className="partner-cards">
          <div className="partner-card reveal">
            ...
            <div className="pc-body">
              ...
              <p>Empresa con presencia en todo el país y una amplia gama de productos de alta calidad.</p>
            </div>
          </div>
          ...
          <div className="partner-card reveal">
            ...
            <div className="pc-body">
              <h3>Hipermaxi</h3>
              <p>Red de supermercados con presencia en todo el país y una amplia gama de productos de alta calidad.</p>
            </div>
          </div>
      ...
      <section className="contact-section" id="contacto">
        <div className="contact-inner">
          <div className="contact-hdr reveal">
            ...
            <h2>¿Cómo <em>contactarnos?</em></h2>
          </div>

          <div className="contact-body">
            {/* Botones sociales */}
            <div className="social-buttons reveal">
              <button className="social-btn sb-wa">
              ...
              <button className="social-btn sb-ig">
                <div className="sb-icon">
              ...
              <button className="social-btn sb-tt">
                <div className="sb-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
              ...
              <button className="social-btn sb-fb">
                <div className="sb-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
            ...
            <div className="contact-info-panel reveal">
              ...
              <div className="cinfo-row">
                ...
                <div className="cinfo-text">
                  ...
                  <div className="cinfo-val">La Paz, Bolivia</div>
                </div>
              </div>
              <div className="cinfo-row">
                <div className="cinfo-icon">📱</div>
                <div className="cinfo-text">
                  ...
                  <div className="cinfo-val">+591 XXX XXXXX</div>
                </div>
              </div>
              <div className="cinfo-row">
                <div className="cinfo-icon">📧</div>
                <div className="cinfo-text">
                  ...
                  <div className="cinfo-val">contacto@vdncosmetics.com</div>
                </div>
              </div>
              <div className="cinfo-row">
                <div className="cinfo-icon">🕐</div>
                <div className="cinfo-text">
                  ...
                  <div className="cinfo-val">Lun – Sáb, 9:00 – 19:00</div>
                </div>
              </div>
            </div>
          </div>
